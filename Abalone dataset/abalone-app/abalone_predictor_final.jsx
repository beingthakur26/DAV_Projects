...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .app {
    min-height: 100vh;
    background: radial-gradient(ellipse at 20% 0%, #0a2a3d 0%, #020d18 60%),
...
export default function AbalonePredictor() {
  ...
  const allFilled = Object.values(fields).every(v => v !== "") && sex !== "";
